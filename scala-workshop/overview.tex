...
There is an implicit \lstinline{finish} surrounding the main method of the program (which is itself an implicit task).
...
benchmarks, and provide contrast with the familiar actor paradigm of Akka.
